        ...
        if st.button("Proses"):
            ...
            with st.sidebar:
                ...
                if prediction == 'Tomato healthy':
                    ...
                    st.warning(f"Penyakit {prediction}")
                st.write("Akurasi prediksi %:", x)

            if prediction == 'Tomato healthy':
                st.subheader("Terdeteksi:")
                st.markdown(f"<h6 style='color:green;'>Tanaman dalam kondisi sehat.</h6>", unsafe_allow_html=True)

            elif prediction == 'Tomato Bacterial spot':
                st.subheader("Terdeteksi:")
                st.markdown(f"<h6 style='color:orange;'>Bercak Bakteri pada Tomat ({prediction})</h6>", unsafe_allow_html=True)
                st.subheader("Solusi:")
                ...
                st.subheader("Terdeteksi:")
                st.markdown(f"<h6 style='color:orange;'>Hawar Dini pada Tomat ({prediction})</h6>", unsafe_allow_html=True)
                st.subheader("Solusi:")
                ...
                st.subheader("Terdeteksi:")
                st.markdown(f"<h6 style='color:orange;'>Hawar Akhir pada Tomat ({prediction})</h6>", unsafe_allow_html=True)
                st.subheader("Solusi:")
                ...
                st.subheader("Terdeteksi:")
                st.markdown(f"<h6 style='color:orange;'>Jamur Daun pada Tomat ({prediction})</h6>", unsafe_allow_html=True)
                st.subheader("Solusi:")
                ...
                st.subheader("Terdeteksi:")
                st.markdown(f"<h6 style='color:orange;'>Bercak Daun Septoria pada Tomat ({prediction})</h6>", unsafe_allow_html=True)
                st.subheader("Solusi:")
                ...
                st.subheader("Terdeteksi:")
                st.markdown(f"<h6 style='color:orange;'>Tungau Laba-laba pada Tomat ({prediction})</h6>", unsafe_allow_html=True)
                st.subheader("Solusi:")
                ...
                st.subheader("Terdeteksi:")
                st.markdown(f"<h6 style='color:orange;'>Bercak Target pada Tomat ({prediction})</h6>", unsafe_allow_html=True)
                st.subheader("Solusi:")
                ...
                st.subheader("Terdeteksi:")
                st.markdown(f"<h6 style='color:orange;'>Virus Keriting Daun Kuning pada Tomat ({prediction})</h6>", unsafe_allow_html=True)
                st.subheader("Solusi:")
                ...
                st.subheader("Terdeteksi:")
                st.markdown(f"<h6 style='color:orange;'>Virus Mosaik pada Tomat ({prediction})</h6>", unsafe_allow_html=True)
                st.subheader("Solusi:")
